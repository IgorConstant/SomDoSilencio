...
var NgxEditorComponent = class _NgxEditorComponent {
  ...
  unsubscribe = new import_rxjs.Subject();
  onChange = () => {
  };
  onTouched = () => {
  };
  ...
  ngOnInit() {
    ...
    this.editor.valueChanges.pipe((0, import_operators.takeUntil)(this.unsubscribe)).subscribe((jsonDoc) => {
...
var MenuService = class _MenuService {
  editor;
  customMenuRefChange = new import_rxjs.Subject();
  setCustomMenuRef(c) {
...
var NgxEditorFloatingMenuComponent = class _NgxEditorFloatingMenuComponent {
  ...
  ngOnInit() {
    ...
    this.resizeSubscription = (0, import_rxjs.fromEvent)(window, "resize").pipe((0, import_operators.throttleTime)(500, import_rxjs.asyncScheduler, {
      leading: true,
      trailing: true
    })).subscribe(() => {
      this.useUpdate();
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    hostBindings: function NgxEditorFloatingMenuComponent_HostBindings(rf, ctx) {
      if (rf & 1) {
        ...
        }, false, ɵɵresolveDocument)("keydown", function NgxEditorFloatingMenuComponent_keydown_HostBindingHandler($event) {
          return ctx.onKeyDown($event);
        }, false, ɵɵresolveDocument)("mouseup", function NgxEditorFloatingMenuComponent_mouseup_HostBindingHandler($event) {
          return ctx.onMouseUp($event);
        }, false, ɵɵresolveDocument)("keyup", function NgxEditorFloatingMenuComponent_keyup_HostBindingHandler($event) {
...
var Editor = class {
  ...
  valueChangesSubject = new import_rxjs.Subject();
  updateSubject = new import_rxjs.Subject();
  get valueChanges() {
