  ...
  constructor() {
    ...
    this.quill$ = (0, import_rxjs2.defer)(() => __async(this, null, function* () {
      if (!this.Quill) {
        ...
        const {
          Quill
        } = yield import("./ngx-quill-quill-CUw8Q_m0-QLQED675.js");
...
var _QuillEditorBase = class _QuillEditorBase {
  ...
  addQuillEventListeners() {
    this.dispose();
    this.zone.runOutsideAngular(() => {
      this.eventsSubscription = new import_rxjs2.Subscription();
...
var _QuillViewComponent = class _QuillViewComponent {
  ...
  ngAfterViewInit() {
    ...
    const quillSubscription = this.service.getQuill().pipe((0, import_operators2.mergeMap)((Quill) => this.service.beforeRender(Quill, this.customModules(), this.beforeRender()))).subscribe((Quill) => {
      const modules = Object.assign({}, this.modules() || this.service.config.modules);
